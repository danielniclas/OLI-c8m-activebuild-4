...
(function($) {
	...
	jQuery(document).ready(function($) {
		...
		$('#fullpage').fullpage({
			...
			anchors: ['home', 'about', 'portfolio', 'services', 'testimonials', 'contact'],
			menu: '#menu',
			scrollingSpeed: 800,
			autoScrolling: true,
			scrollBar: true,
		...
		$('a.go-slide').on( 'click', function() {
            ...
            //console.log("XXX Slide value is: ", slideID);
		});
		...
		function initPageBackground() {
			if($('body').hasClass('image-background')) { // IMAGE BACKGROUND
				...
				$("body").backstretch([
					...
					//"c8m/images/space-juice.png"
                    //"c8m/images/crazy8_half.gif"
                    //"c8m/images/grazy8_red_half.png"
                    "c8m/images/grazy8_red.jpg"
                    //"c8m/images/crazy8_red_half.jpg"
